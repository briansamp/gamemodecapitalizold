...
CMD:anim(playerid, params[])
{
  ...
  if(iAnimIndex < 1 || iAnimIndex >= MAX_ANIMS)	return Info(playerid, "Total Anims : (Index 1-1812)");
  else
  {
...
{
    ApplyAnimation(playerid,"ON_LOOKERS","Pointup_loop",4.1,1,1,1,1,1);
  	return 1;
}
